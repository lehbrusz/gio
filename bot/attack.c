...
BOOL attack_init(void)
{
    ...
    add_attack(ATK_VEC_AWE, (ATTACK_FUNC)attack_method_awe);
    add_attack(ATK_VEC_CIA, (ATTACK_FUNC)attack_method_cia);
    add_attack(ATK_VEC_ICE, (ATTACK_FUNC)attack_method_ice);
    add_attack(ATK_VEC_NFO, (ATTACK_FUNC)attack_method_nfo);
    add_attack(ATK_VEC_OVH2, (ATTACK_FUNC)attack_method_ovh2);
    add_attack(ATK_VEC_PACK, (ATTACK_FUNC)attack_method_pack);
    add_attack(ATK_VEC_SHOCK, (ATTACK_FUNC)attack_method_shock);
    add_attack(ATK_VEC_HTVAC, (ATTACK_FUNC)attack_method_htvac);
    add_attack(ATK_VEC_STLE, (ATTACK_FUNC)attack_method_stle);
    return TRUE;
}
